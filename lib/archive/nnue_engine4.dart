...
// ================================================================
// NO QUIESCENCE — STATIC EVAL ONLY
// ================================================================
...
// ================================================================
// ROOT SEARCH WITH SAFE ASPIRATION
// ================================================================
...
RootMove rootSearch(
  ...
  // Safe aspiration window (wider)
  if (prevEval != null) {
    double w = 500; // NNUE evals vary a lot
    alpha = prevEval - w;
    beta = prevEval + w;
  ...
  for (;;) {
    ...
    if (score <= alpha) {
      ...
      // Identify the move producing best score
